...
<script src="{{ asset('js/amcharts.js') }}" defer></script>
<script src="{{ asset('js/serial.js') }}" defer></script>
<script src="{{ asset('js/light.js') }}" defer></script>
...
<script src="{{ asset('js/vartical-layout.min.js') }}" defer></script>
